...
install_php72() {
    ...
    #定义环境变量
    PATH=/usr/local/php72/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:/bin
    export PATH
    ...
    #定义默认安装程序的下载路径
    defaultVersion=${defaultPHP72Version}
